...
// Version 25 persists the per-task x-codex-turn-state length summary received
// from a Relay process; it never stores the state value itself.
...
const MAX_TRACKED_TURN_STATES = 256;
